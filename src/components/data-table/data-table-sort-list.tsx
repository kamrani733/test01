        ...
        >
          <div className="flex flex-col gap-1">
            <h4 id={labelId} className="font-medium leading-none">
              {sorting.length > 0
                ? dictionary.ui.sort.sortBy
                : dictionary.ui.sort.noSorting}
            </h4>
            <p
              id={descriptionId}
              className={cn(
            ...
            >
              {sorting.length > 0
                ? dictionary.ui.sort.modify
                : dictionary.ui.sort.addSort}
            </p>
          </div>
          {sorting.length > 0 && (
          ...
          <div className="flex w-full items-center gap-2">
            ...
            >
              {dictionary.common.add + " " + dictionary.ui.sort.title}
            </Button>
            {sorting.length > 0 && (
              <Button
                variant="outline"
              ...
              >
                {dictionary.common.reset + " " + dictionary.ui.sort.title}
              </Button>
            )}
          </div>
        </PopoverContent>
      ...
      >
        <Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
          ...
          >
            <Command>
              <CommandInput
                placeholder={`${dictionary.common.search} ${dictionary.common.field}...`}
              />
              <CommandList>
                <CommandEmpty>{dictionary.common.noField}</CommandEmpty>
                <CommandGroup>
                  {columns.map((column) => (
                    <CommandItem
                      key={column.id}
        ...
        >
          ...
          >
            {dataTableConfig.sortOrders.map((priority) => (
