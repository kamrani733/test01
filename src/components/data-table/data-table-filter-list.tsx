...
import { getDefaultFilterOperator, getFilterOperators } from "@/core/lib/data-table";
import { formatDate } from "@/core/lib/format";
import { generateId } from "@/core/lib/id";
import { getFiltersStateParser } from "@/core/lib/parsers";
        ...
        >
          <div className="flex flex-col gap-1">
            <h4 id={labelId} className="font-medium leading-none">
              {filters.length > 0
                ? dictionary.ui.filter.filters
                : dictionary.ui.filter.noFilterApplied}
            </h4>
            <p
              id={descriptionId}
              className={cn(
            ...
            >
              {filters.length > 0
                ? dictionary.ui.filter.addFilter
                : dictionary.ui.filter.addFilter}
            </p>
          </div>
          {filters.length > 0 ? (
          ...
          <div className="flex w-full items-center gap-2">
            <Button
              ...
              onClick={onFilterAdd}
            >
              {dictionary.common.add + " " + dictionary.ui.filter.title}
            </Button>
            {filters.length > 0 ? (
              <Button
                variant="outline"
              ...
              >
                {dictionary.common.reset + " " + dictionary.ui.filter.title}
              </Button>
            ) : null}
          </div>
        </PopoverContent>
