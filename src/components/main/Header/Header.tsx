...
export default async function Header() {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 h-18 bg-white/95 backdrop-blur-sm border-b border-[#E8E8E8] text-[#2F2F2F] flex items-center justify-between px-4 py-4 sm:px-6 lg:px-12 shadow-sm">
