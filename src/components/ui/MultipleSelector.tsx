  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "flex items-start justify-between rounded-md border border-input px-3 py-2 text- ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 md:text-sm",
            {
